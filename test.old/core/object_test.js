...
test('create implementation', function() {
    ...
    M.TestObject = M.Object.extend(M.Object);

    ok(Object.getPrototypeOf(M.TestObject) === M.Object, 'The prototype of Testobject is the paramter');

    ok(M.TestObject = M.Object.extend('test'), 'The prototype parameter is a string');

    ok(M.TestObject = M.Object.extend([]), 'The prototype parameter is an array');

    ok(M.TestObject = M.Object.extend(null), 'The prototype parameter is null');

    ok(M.TestObject = M.Object.extend(undefined), 'The prototype parameter is undefined');

    M.TestObject = M.Object.extend({test: 'test'});
    ...
    M.TestObject = M.Object.extend({test: function( param ) {
...
// FS.: the keys function is will override Backbone.Model.keys
/*
